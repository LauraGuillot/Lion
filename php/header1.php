...
function afficheHeader() {
    ...
    if (strcmp($file , 'inscription.php') == 0 || strcmp($file, 'inscription2.php' )==0 || strcmp($file , 'inscription3.php')==0 || strcmp($file , 'inscriptionnew2.php')==0 || strcmp($file , 'inscriptionnew3.php')==0 || strcmp($file , 'inscriptionnew.php')==0) {
        echo' 
    <html>
         <header class="mobile">
